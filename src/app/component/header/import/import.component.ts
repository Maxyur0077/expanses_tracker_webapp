    ...
    for (let j = 1; j < this.csvRecords.length - 1; j++) {
      ...
      for (let i = 0; i < this.propertyNames.length; i++) {
        ...
        if (
          ...
          this.propertyNames[i] === 'expense_name' ||
          this.propertyNames[i] === 'expense name'
        ) {
          if (
            this.csvRecords[j][i] &&
            (this.csvRecords[j][i] != '' || this.csvRecords[j][i] != ' ')
          ) {
            hashamp['expense_name'] = this.csvRecords[j][i];
            name = true;
          }
        } else if (
          this.propertyNames[i] === 'amount' ||
          this.propertyNames[i] === 'amounts'
        ) {
          if (
            this.csvRecords[j][i] &&
            (this.csvRecords[j][i] != '' || this.csvRecords[j][i] != ' ')
          ...
          this.propertyNames[i] === 'expense date' ||
          this.propertyNames[i] === 'date' ||
          this.propertyNames[i] === 'expense_date'
        ) {
          if (
            this.csvRecords[j][i] &&
            (this.csvRecords[j][i] != '' || this.csvRecords[j][i] != ' ')
          ...
          this.propertyNames[i] === 'payment' ||
          this.propertyNames[i] === 'payment_type' ||
          this.propertyNames[i] === 'payment type'
        ) {
          if (
            this.csvRecords[j][i] &&
            (this.csvRecords[j][i] != '' || this.csvRecords[j][i] != ' ')
          ...
          this.propertyNames[i] === 'expense_category' ||
          this.propertyNames[i] === 'expense category' ||
          this.propertyNames[i] === 'category'
        ) {
          if (
            this.csvRecords[j][i] &&
            (this.csvRecords[j][i] != '' || this.csvRecords[j][i] != ' ')
          ...
          this.propertyNames[i] === 'comments' ||
          this.propertyNames[i] === 'comment'
        ) {
          if (
            this.csvRecords[j][i] &&
            (this.csvRecords[j][i] != '' || this.csvRecords[j][i] != ' ')
